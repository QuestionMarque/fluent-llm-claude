...
class VariableMapper:
    ...
    def _map_distribution(self, params: Dict[str, Any]) -> Dict[str, Any]:
        result: Dict[str, Any] = {}
        _set_if(result, "volumes", params.get("volumes"))
    ...
    def _map_get_tips(self, params: Dict[str, Any]) -> Dict[str, Any]:
        result: Dict[str, Any] = {}
        _set_if(result, "tip_type", _resolve_tip_type(params) or params.get("tip_type"))
        return result
    ...
    def _map_incubate(self, params: Dict[str, Any]) -> Dict[str, Any]:
        result: Dict[str, Any] = {}
        _set_if(result, "duration_seconds", params.get("duration_seconds"))
        _set_if(result, "temperature_celsius", params.get("temperature_celsius"))
        _set_if(result, "device", params.get("device"))
        return result
